      ...
      <div className="min-h-screen bg-black pt-[72px] pb-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="animate-pulse space-y-8 mt-10">
            ...
            <div className="h-64 bg-gray-900/40 rounded-3xl border border-gray-800"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-10 pt-8 animate-fadeInUp">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              <h1 className="text-4xl font-black text-white tracking-tight mb-2">Manajemen Mobil</h1>
        ...
        <section className="glass-card bg-gray-900/40 rounded-[2.5rem] p-10 border border-gray-800 mb-12 animate-fadeInUp" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full bg-gray-800/50 border border-gray-700 text-white rounded-2xl px-6 py-4 focus:ring-2 focus:ring-brand-500 outline-none transition-all placeholder:text-gray-600 font-bold"
              />
            </div>
            <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                />
                <div className="w-full bg-gray-800/50 border border-dashed border-gray-700 text-gray-500 rounded-2xl px-6 py-4 flex items-center justify-center gap-3 group-hover:bg-gray-800 transition-colors">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            {selectedFile && (
              <button
                ...
                disabled={isUploading}
                className="w-full md:w-auto bg-blue-600/10 hover:bg-blue-600 text-blue-400 hover:text-white border border-blue-500/20 px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all disabled:opacity-50"
              >
        ...
        <div className="animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
          <div className="flex items-center justify-between mb-8">
             ...
             <div className="relative group w-full max-w-xs hidden md:block">
                <input 
                  ...
                  className="w-full bg-gray-900/40 border border-gray-800 text-white rounded-xl px-6 py-2.5 text-[10px] font-black tracking-widest focus:border-brand-500 transition-all outline-none"
                />
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredMobil.map((m) => (
              <div key={m.id} className="glass-card bg-gray-900/40 rounded-[2.5rem] border border-gray-800 overflow-hidden hover:border-brand-500/30 transition-all group flex flex-col">
