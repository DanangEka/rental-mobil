...
export default function CompanyProfile() {
  ...
  return (
    <div className={`min-h-screen bg-black pt-[72px] pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-all duration-1000 ${animate ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
      ...
      <div className="w-full max-w-5xl mx-auto z-10 relative mt-8 flex flex-col items-center">
        {/* Logo Header */}
        <div className="flex flex-col items-center mb-12 text-center group cursor-default">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mt-8 mb-4">Cakra Lima Tujuh</h1>
          <p className="text-brand-300 font-bold tracking-widest uppercase text-sm md:text-base">Premium Car Rental Solution</p>
        </div>

        {/* About Section */}
        <div className="glass-card bg-gray-900/60 p-8 sm:p-12 border border-gray-800 rounded-3xl shadow-2xl relative overflow-hidden w-full mb-12">
          {/* Subtle top glare */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-black/40 border border-gray-800 p-6 rounded-2xl flex flex-col items-center text-center group hover:border-brand-500/50 transition-colors">
              ...
              <div className="bg-black/40 border border-gray-800 p-6 rounded-2xl flex flex-col items-center text-center group hover:border-brand-500/50 transition-colors sm:col-span-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          <a
            ...
            className="group flex flex-col justify-center gap-4 bg-gray-900/60 border border-gray-800 p-6 sm:p-8 rounded-3xl hover:shadow-brand hover:border-brand-500/50 transition-all duration-300 backdrop-blur-md relative overflow-hidden"
          >
